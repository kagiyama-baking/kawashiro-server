# Migration to move MSGraphConfig from onedrive to ms_graph
...
class Migration(migrations.Migration):
    """
    onedrive.MSGraphConfigをms_graph.MSGraphConfigに移行するマイグレーション

    既存のonedrive_msgraphconfigテーブルをms_graph_msgraphconfigにリネームします。
    """
    ...
    operations = [
        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    sql='ALTER TABLE "onedrive_msgraphconfig" RENAME TO "ms_graph_msgraphconfig"',
                    reverse_sql='ALTER TABLE "ms_graph_msgraphconfig" RENAME TO "onedrive_msgraphconfig"',
                ),
            ],
        ),
    ]
