...
class TestCreateUserView:
    ...
    def test_create_user_with_duplicate_email_fails(self, superuser_client, regular_user):
...
class TestManageUserView:
    ...
    def test_update_email_to_existing_email_fails(self, authenticated_client, superuser):
