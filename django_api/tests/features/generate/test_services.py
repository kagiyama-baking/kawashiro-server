...
from features.generate.services import GreetingService
...
class TestGreetingService:
    ...
    @patch("features.generate.services.HolidayClient")
    @patch("features.generate.services.OpenAIClient")
    ...
    @patch("features.generate.services.HolidayClient")
    @patch("features.generate.services.JMAWeatherClient")
    @patch("features.generate.services.OpenAIClient")
    ...
    @patch("features.generate.services.HolidayClient")
    @patch("features.generate.services.JMAWeatherClient")
    @patch("features.generate.services.OutlookMSGraphClient")
    @patch("features.generate.services.OpenAIClient")
    ...
    @patch("features.generate.services.HolidayClient")
    @patch("features.generate.services.OpenAIClient")
    @patch("features.generate.services.TTSClient")
