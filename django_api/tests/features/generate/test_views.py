...
from features.generate.models import GreetingConfig
...
class TestTodayInfoView:
    ...
    @patch("features.generate.views.HolidayClient")
    @patch("features.generate.views.datetime")
    ...
    def test_today_info_holiday_api_network_error(
        ...
        from features.generate.exceptions import HolidayNetworkError
    ...
    def test_today_info_holiday_api_timeout(
        ...
        """祝日APIタイムアウト時は504エラー"""
        from features.generate.exceptions import HolidayTimeoutError
...
class TestGreetingView:
    ...
    def url(self):
        """エンドポイントURL"""
        return reverse("generate:generate")
    ...
    @patch("features.generate.views.GreetingService")
    ...
    def test_greeting_with_tts_enabled(
        ...
        assert "X-Generate-Text" in response
    ...
    def test_greeting_header_sanitizes_control_chars(
        ...
        """X-Generate-Textヘッダーから制御文字が除去される"""
        ...
        assert response.status_code == status.HTTP_200_OK
        raw_header = response["X-Generate-Text"]
...
class TestConfigsListView:
    ...
    def url(self):
        """エンドポイントURL"""
        return reverse("generate:configs")
