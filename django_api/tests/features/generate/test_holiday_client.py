...
from features.generate.exceptions import HolidayNetworkError, HolidayTimeoutError
from features.generate.holiday_client import HolidayClient
...
class TestHolidayClient:
    ...
    @patch("features.generate.holiday_client.requests.get")
