...
from features.generate.admin import GenerateConfigAdmin
from features.generate.models import GreetingConfig


@pytest.mark.django_db
class TestGenerateConfigAdmin:
    """GenerateConfigAdmin のテスト"""
    ...
    def test_list_display_contains_expected_fields(self):
        ...
        admin_instance = GenerateConfigAdmin(GreetingConfig, AdminSite())
