...
class WelcomeHomeGreetingService(BaseGreetingService):
    """おかえりの挨拶生成サービス."""
    ...
    def generate_greeting(
        ...
        Raises:
            ...
            OpenAIAPIError: OpenAI API接続エラー
        """
        logger.info("おかえりの挨拶を生成: area_code=%s", area_code)
        ...
        # プロンプトを構築
        built_user_prompt = self._build_user_prompt(
            user_prompt, weather_data, datetime_data
        )
